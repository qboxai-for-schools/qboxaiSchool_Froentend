...
export default function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-16 bg-gradient-to-b from-gray-800 to-gray-900 flex flex-col items-center py-6 shadow-lg rounded-l-xl z-50">
      ...
      <div className="mb-8">
        <div
          className={`w-10 h-10 rounded-xl bg-gradient-to-br ${roleColors[userType]} flex items-center justify-center shadow-md hover:shadow-2xl hover:shadow-violet-500/50 hover:scale-110 transition-all duration-300 cursor-pointer hover:bg-gradient-to-br hover:from-violet-500 hover:via-fuchsia-500 hover:to-pink-500`}
        >
            ...
            <button
              ...
              className={`w-full h-11 flex items-center justify-center rounded-xl transition-all duration-300 group relative ${
                isActive
                  ...
                  : `text-gray-400 ${roleHoverGradients[userType]} hover:text-white hover:shadow-lg hover:shadow-violet-500/30 hover:scale-105 hover:backdrop-blur-lg hover:border hover:border-white/20`
              }`}
            >
